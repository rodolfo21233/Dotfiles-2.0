...
RowLayout {
    ...
    property string trackTitleOutput: Players.activePlayer?.trackTitle
        ? Players.activePlayer.trackTitle + " - "
        : ""
    property string trackArtistOutput: Players.activePlayer?.trackArtist
        ? Players.activePlayer.trackArtist
        : ""
    property string trackOutput: hasPlayer
        ? trackTitleOutput + trackArtistOutput
        : ""
